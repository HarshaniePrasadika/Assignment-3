...
const ul = document.createElement('ul');
  ...
  function empty(){
    var arr=[];
    arr[0]=document.getElementById("email");
    arr[1]=document.getElementById("sub");
	arr[2]=document.getElementById("name");
	arr[3]=document.getElementById("mess");
	arr[4]=document.getElementById("pnumber");
